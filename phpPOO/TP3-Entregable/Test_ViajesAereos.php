...
$viajeAereo = new ViajesAereos(100,"Bariloche",10,$pasajeros,$respon, 400 , "si", 400, "1°clase","arg",3);

$pasajero = new Pasajeros("juan","perez",5678492,299084659);
echo ($viajeAereo->venderPasaje($pasajero))? "Se agrego pasajero \n ": "no se agrego pasajero \n";
echo $viajeAereo->getImporte()."\n\n";
