...
$viajeTerrestre = new ViajesTerrestres(100,"Bariloche",10,$pasajeros,$respon,400,"no","cama");
//echo "\n VIAJE TERRESTRE\n".$viajeTerrestre."\n\n";

$viajeAereo = new ViajesAereos(100,"Bariloche",10,$pasajeros,$respon,400,"no",567,"primera clase","ARG",0);
//echo "\n VIAJE AEREO\n".$viajeAereo."\n\n";
...
do{
    ...
    elseif($opcion == 4){
        ...
        //selecciona que tipo de viaje para saber que datos pedir y a que clase hija llamar 
        ...
        if ($opcion == "terrestre")
        {
            ...
            $ida_vuelta = trim(fgets(STDIN));
            $viajeTerrestre -> setIdaYVuelta($ida_vuelta);
        ...
        elseif($opcion == "aereo")
        {
            echo "Categoria Asiento(primera clase/normal): ";
            $catAsiento = trim(fgets(STDIN));
            $viajeAereo->setCategoriaAsiento($catAsiento);
            echo "Ida y Vuelta(si/no): ";
            $ida_vuelta = trim(fgets(STDIN));
            $viajeAereo -> setIdaYVuelta($ida_vuelta);
